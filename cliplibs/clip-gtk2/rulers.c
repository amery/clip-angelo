...
clip_GTK_RULERGETRANGE(ClipMachine * ClipMachineMemory)
{
   ...
   _clip_stornd(ClipMachineMemory, lower, 2, 0);
   _clip_stornd(ClipMachineMemory, upper, 3, 0);
   _clip_stornd(ClipMachineMemory, position, 4, 0);
   _clip_stornd(ClipMachineMemory, max_size, 5, 0);
   return 0;
 err:
   return 1;
}
