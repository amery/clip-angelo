...
clip_GTK_CONTAINERADDWITHPROPERTIES(ClipMachine * ClipMachineMemory)
{
   ...
   for (i = 0; i < cv->ClipArrVar_a_of_ClipVar.count_of_ClipArrVar; i++)
      pname[i] =
       cv->ClipArrVar_a_of_ClipVar.ClipVar_items_of_ClipArrVar[i].ClipStrVar_s_of_ClipVar.ClipBuf_str_of_ClipStrVar.
       buf_of_ClipBuf;

   gtk_container_add_with_properties(GTK_CONTAINER(ccon->widget),
				     cwid->widget, pname[0], pname[1],
				     pname[2], pname[3], pname[4], pname[5],
				     pname[6], pname[7], pname[8], pname[9],
				     pname[10], pname[11], pname[12],
				     pname[13], pname[14], pname[15], pname[16], pname[17], pname[18], pname[19], NULL);
   return 0;
 err:
   return 1;
}
...
clip_GTK_CONTAINERCHILDGET(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_container_child_get(GTK_CONTAINER(ccon->widget), cwid->widget,
			   ...
			   pname[5], pname[6], pname[7], pname[8], pname[9],
			   pname[10], pname[11], pname[12], pname[13],
			   pname[14], pname[15], pname[16], pname[17], pname[18], pname[19], NULL);
