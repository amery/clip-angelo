...
{
   _wtype_table_put(_clip_type_tearoff_menu_item,
		    _clip_type_name_tearoff_menu_item, _gtk_type_tearoff_menu_item, _gtk_type_menu_item, NULL);
   return 0;
}
...
{
   _wtype_table_put(_clip_type_separator_menu_item,
		    _clip_type_name_separator_menu_item, _gtk_type_tearoff_menu_item, _gtk_type_menu_item, NULL);
   return 0;
}
