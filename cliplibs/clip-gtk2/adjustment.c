...
clip_GTK_ADJUSTMENTGETVALUE(ClipMachine * ClipMachineMemory)
{
   ...
   _clip_stornd(ClipMachineMemory, gtk_adjustment_get_value(GTK_ADJUSTMENT(cadj->widget)), 2, 0);
   _clip_stornd(ClipMachineMemory, GTK_ADJUSTMENT(cadj->widget)->lower, 3, 0);
   _clip_stornd(ClipMachineMemory, GTK_ADJUSTMENT(cadj->widget)->upper, 4, 0);
