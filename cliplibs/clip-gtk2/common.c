   ...
   while (cv)
      {
			...
			if (((ClipVar *) & (widget_list->ClipMapVar_m_of_ClipVar.ClipVarEl_items_of_ClipMapVar[0]))->ClipMapVar_m_of_ClipVar.count_of_ClipMapVar)
				cv = (ClipVar *) & (widget_list->ClipMapVar_m_of_ClipVar.ClipVarEl_items_of_ClipMapVar[0]);
	 else
	    break;
	 C_object *cobj = (C_object *) ((long) (((ClipVar *) & (cv->ClipMapVar_m_of_ClipVar.ClipVarEl_items_of_ClipMapVar[0]))->ClipNumVar_n_of_ClipVar.double_of_ClipNumVar));
	C_widget *cwid = (C_widget *) ((long) (((ClipVar *) & (cv->ClipMapVar_m_of_ClipVar.ClipVarEl_items_of_ClipMapVar[0]))->ClipNumVar_n_of_ClipVar.double_of_ClipNumVar));
...
_fetch_cwidget(ClipMachine * ClipMachineMemory, ClipVar * cv)
{
   ...
   if (cv->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == NUMERIC_type_of_ClipVarType)
      {
	 cwid = (C_widget *) _clip_fetch_c_item(ClipMachineMemory, cv->ClipNumVar_n_of_ClipVar.double_of_ClipNumVar, _C_ITEM_TYPE_WIDGET);
      }
   else
      {
...
_fetch_cobject(ClipMachine * ClipMachineMemory, ClipVar * cv)
{
   ...
   if (cv->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == NUMERIC_type_of_ClipVarType)
      {
	 cobj = (C_object *) _clip_fetch_c_item(ClipMachineMemory, cv->ClipNumVar_n_of_ClipVar.double_of_ClipNumVar, _C_ITEM_TYPE_WIDGET);
      }
   else
      {
	 if (cv->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == MAP_type_of_ClipVarType)
...
{
   if (map->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == MAP_type_of_ClipVarType || map->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == NUMERIC_type_of_ClipVarType)
      {
   ...
   if (map->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == ARRAY_type_of_ClipVarType)
	 ...
	 for (i = 0; i < a->count_of_ClipArrVar && i < 5; i++)
	    {
	       if (a->ClipVar_items_of_ClipArrVar[i].ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType != MAP_type_of_ClipVarType
		   && a->ClipVar_items_of_ClipArrVar[i].ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType != NUMERIC_type_of_ClipVarType)
		  continue;
...
_style_to_map(ClipMachine * ClipMachineMemory, GtkStyle * style, ClipVar * m_style)
{
  ...
  /* Get colors of widget */
   ...
   if (style->colormap)
	 ...
	 if (!ccmap)
	    ccmap = _register_object(ClipMachineMemory, style->colormap, GDK_OBJECT_COLORMAP, NULL, (coDestructor) gdk_object_colormap_destructor);
	 if (ccmap)
	    {
...
/* Set colormap of widget */
   ...
   if (c && (c->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == MAP_type_of_ClipVarType || c->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == NUMERIC_type_of_ClipVarType))
      {
...
/* Set font of widget */
   ...
   if (c && (c->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == CHARACTER_type_of_ClipVarType || c->ClipType_t_of_ClipVar.ClipVartype_type_of_ClipType == ARRAY_type_of_ClipVarType))
      {
...
_arr_to_valist(ClipMachine * ClipMachineMemory, ClipVar * marg, va_list valist)
{
  /*
     ...
     g_value_set_string(&value, elem->ClipStrVar_s_of_ClipVar.ClipBuf_str_of_ClipStrVar.buf_of_ClipBuf);
     break;
...
{
   target->target = cv->ClipArrVar_a_of_ClipVar.ClipVar_items_of_ClipArrVar[0].ClipStrVar_s_of_ClipVar.ClipBuf_str_of_ClipStrVar.buf_of_ClipBuf;
   target->flags = (guint) cv->ClipArrVar_a_of_ClipVar.ClipVar_items_of_ClipArrVar[1].ClipNumVar_n_of_ClipVar.double_of_ClipNumVar;
   target->info = (guint) cv->ClipArrVar_a_of_ClipVar.ClipVar_items_of_ClipArrVar[2].ClipNumVar_n_of_ClipVar.double_of_ClipNumVar;
}
