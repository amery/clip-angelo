...
_tag_set_property(ClipMachine * ClipMachineMemory, gint p, GtkTextTag * tag, const gchar * pname)
{
   ...
   switch (hash)
	 ...
	 g_object_set(G_OBJECT(tag), pname, (GdkColor *) ((_fetch_cobject(ClipMachineMemory, _clip_par(ClipMachineMemory, p)))->object), NULL);
	 break;
...
clip_GTK_TEXTBUFFERINSERTINTERACTIVE(ClipMachine * ClipMachineMemory)
{
   ...
   buf[len] = 0;
   LOCALE_TO_UTF(buf);
   ret = gtk_text_buffer_insert_interactive(GTK_TEXT_BUFFER(cbuffer->object), GTK_TEXT_ITER(citer->object), (const gchar *) buf, strlen(buf), editable);
   FREE_TEXT(buf);
...
clip_GTK_TEXTBUFFERINSERTINTERACTIVEATCURSOR(ClipMachine * ClipMachineMemory)
{
   ...
   buf[len] = 0;
   LOCALE_TO_UTF(buf);
   ret = gtk_text_buffer_insert_interactive_at_cursor(GTK_TEXT_BUFFER(cbuffer->object), (const gchar *) buf, strlen(buf), editable);
   FREE_TEXT(buf);
   _clip_retl(ClipMachineMemory, ret);
   return 0;
 err:
...
clip_GTK_TEXTBUFFERINSERTRANGE(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_insert_range(GTK_TEXT_BUFFER(cbuffer->object), GTK_TEXT_ITER(citer->object), (const GtkTextIter *) (citerstart->object), (const GtkTextIter *) (citerend->object));
   return 0;
 err:
   return 1;
}
...
clip_GTK_TEXTBUFFERINSERTRANGEINTERACTIVE(ClipMachine * ClipMachineMemory)
{
   ...
   ret =
      gtk_text_buffer_insert_range_interactive(GTK_TEXT_BUFFER
					       (cbuffer->object), GTK_TEXT_ITER(citer->object), (const GtkTextIter *) (citerstart->object), (const GtkTextIter *) (citerend->object), editable);
   _clip_retl(ClipMachineMemory, ret);
   return 0;
 err:
   return 1;
...
clip_GTK_TEXTBUFFERINSERTWITHTAGS(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_insert_with_tags(GTK_TEXT_BUFFER(cbuffer->object),
				    ...
				    tags[4], tags[5], tags[6], tags[7], tags[8], tags[9], tags[10], tags[11], tags[12], tags[13], tags[14], tags[15], tags[16], tags[17], tags[18], tags[19], NULL);
   FREE_TEXT(buf);
   return 0;
 err:
   return 1;
...
clip_GTK_TEXTBUFFERINSERTWITHTAGSBYNAME(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_insert_with_tags_by_name(GTK_TEXT_BUFFER(cbuffer->object),
					    ...
					    tags[6], tags[7], tags[8], tags[9], tags[10], tags[11], tags[12], tags[13], tags[14], tags[15], tags[16], tags[17], tags[18], tags[19], NULL);
   FREE_TEXT(buf);
   return 0;
 err:
   return 1;
...
clip_GTK_TEXTBUFFERDELETEINTERACTIVE(ClipMachine * ClipMachineMemory)
{
   ...
   ret = gtk_text_buffer_delete_interactive(GTK_TEXT_BUFFER(cbuffer->object), GTK_TEXT_ITER(citerstart->object), GTK_TEXT_ITER(citerend->object), editable);
   _clip_retl(ClipMachineMemory, ret);
   return 0;
 err:
   return 1;
...
clip_GTK_TEXTBUFFERGETTEXT(ClipMachine * ClipMachineMemory)
{
   ...
   str = gtk_text_buffer_get_text(GTK_TEXT_BUFFER(cbuffer->object), (const GtkTextIter *) (citerstart->object), (const GtkTextIter *) (citerend->object), incl);
   LOCALE_FROM_UTF(str);
...
clip_GTK_TEXTBUFFERGETSLICE(ClipMachine * ClipMachineMemory)
{
   ...
   str = gtk_text_buffer_get_slice(GTK_TEXT_BUFFER(cbuffer->object), (const GtkTextIter *) (citerstart->object), (const GtkTextIter *) (citerend->object), incl);
   LOCALE_FROM_UTF(str);
   _clip_retc(ClipMachineMemory, str);
   FREE_TEXT(str);
   return 0;
...
clip_GTK_TEXTBUFFERINSERTCHILDANCHOR(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_insert_child_anchor(GTK_TEXT_BUFFER(cbuffer->object), GTK_TEXT_ITER(citer->object), GTK_TEXT_CHILD_ANCHOR(canchor->object));
   return 0;
 err:
   return 1;
}
...
clip_GTK_TEXTBUFFERMOVEMARK(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_move_mark(GTK_TEXT_BUFFER(cbuffer->object), GTK_TEXT_MARK(cmark->object), (const GtkTextIter *) (citer->object));
...
clip_GTK_TEXTBUFFERAPPLYTAG(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_apply_tag(GTK_TEXT_BUFFER(cbuffer->object), GTK_TEXT_TAG(ctag->object), (const GtkTextIter *) (cstart->object), (const GtkTextIter *) (cend->object));
...
clip_GTK_TEXTBUFFERREMOVETAG(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_remove_tag(GTK_TEXT_BUFFER(cbuffer->object), GTK_TEXT_TAG(ctag->object), (const GtkTextIter *) (cstart->object), (const GtkTextIter *) (cend->object));
...
clip_GTK_TEXTBUFFERAPPLYTAGBYNAME(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_apply_tag_by_name(GTK_TEXT_BUFFER(cbuffer->object), name, (const GtkTextIter *) (cstart->object), (const GtkTextIter *) (cend->object));
...
clip_GTK_TEXTBUFFERREMOVETAGBYNAME(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_remove_tag_by_name(GTK_TEXT_BUFFER(cbuffer->object), name, (const GtkTextIter *) (cstart->object), (const GtkTextIter *) (cend->object));
...
clip_GTK_TEXTBUFFERREMOVEALLTAGS(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_remove_all_tags(GTK_TEXT_BUFFER(cbuffer->object), (const GtkTextIter *) (cstart->object), (const GtkTextIter *) (cend->object));
...
clip_GTK_TEXTBUFFERPASTECLIPBOARD(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_text_buffer_paste_clipboard(GTK_TEXT_BUFFER(cbuffer->object), GTK_CLIPBOARD(cclipboard->object), ((citer != NULL) ? GTK_TEXT_ITER(citer->object) : NULL), editable);
...
clip_GTK_TEXTBUFFERBACKSPACE(ClipMachine * ClipMachineMemory)
{
   ...
   _clip_retl(ClipMachineMemory, gtk_text_buffer_backspace(GTK_TEXT_BUFFER(cbuffer->object), GTK_TEXT_ITER(citer->object), interactive, def_editable));
