...
int
clip_GTK_MISCGETALIGNMENT(ClipMachine * ClipMachineMemory)
{
   C_widget *cmisc = _fetch_cw_arg(ClipMachineMemory);
   gfloat xalign;
   gfloat yalign;
   ...
   _clip_storni(ClipMachineMemory, xalign, 2, 0);
   _clip_storni(ClipMachineMemory, yalign, 3, 0);
   return 0;
 err:
   return 1;
}
...
int
clip_GTK_MISCGETPADDING(ClipMachine * ClipMachineMemory)
{
   C_widget *cmisc = _fetch_cw_arg(ClipMachineMemory);
   gint xpad;
   gint ypad;
   ...
   _clip_storni(ClipMachineMemory, xpad, 2, 0);
   _clip_storni(ClipMachineMemory, ypad, 3, 0);
   return 0;
 err:
   return 1;
}
