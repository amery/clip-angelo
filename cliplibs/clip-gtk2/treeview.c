...
clip_GTK_TREEVIEWMOVECOLUMNAFTER(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_view_move_column_after(GTK_TREE_VIEW(ctree->widget), GTK_TREE_VIEW_COLUMN(ccolumn->object), GTK_TREE_VIEW_COLUMN(cbase_column->object));
...
clip_GTK_TREEVIEWSCROLLTOCELL(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_view_scroll_to_cell(GTK_TREE_VIEW(ctree->widget), GTK_TREE_PATH(cpath->object), (ccolumn) ? GTK_TREE_VIEW_COLUMN(ccolumn->object) : NULL, use_align, row_align, col_align);
...
clip_GTK_TREEVIEWSETCURSOR(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_view_set_cursor(GTK_TREE_VIEW(ctree->widget), GTK_TREE_PATH(cpath->object), (ccolumn) ? GTK_TREE_VIEW_COLUMN(ccolumn->object) : NULL, start_editing);
...
clip_GTK_TREEVIEWROWACTIVATED(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_view_row_activated(GTK_TREE_VIEW(ctree->widget), GTK_TREE_PATH(cpath->object), GTK_TREE_VIEW_COLUMN(ccolumn->object));
...
clip_GTK_TREEVIEWGETCELLAREA(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_view_get_cell_area(GTK_TREE_VIEW(ctree->widget), GTK_TREE_PATH(cpath->object), GTK_TREE_VIEW_COLUMN(ccolumn->object), &rect);
...
clip_GTK_TREEVIEWGETBACKGROUNDAREA(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_view_get_background_area(GTK_TREE_VIEW(ctree->widget), GTK_TREE_PATH(cpath->object), GTK_TREE_VIEW_COLUMN(ccolumn->object), &rect);
...
clip_GTK_TREEVIEWSETCURSORONCELL(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_view_set_cursor_on_cell(GTK_TREE_VIEW(ctree->widget),
				    GTK_TREE_PATH(cpath->object), (ccolumn) ? GTK_TREE_VIEW_COLUMN(ccolumn->object) : NULL, (crender) ? GTK_CELL_RENDERER(crender->object) : NULL, start_edit);
