...
/* structure is READONLY for the user */
   ...
   struct _GtkExTextClass
   {
     ...
     /* Signals from GtkEditable */
      void (*insert_text) (GtkExText * text, const gchar * new_text, gint length, gint * position);
     ...
     /* End of GtkEditable signals */
      ...
      void (*set_scroll_adjustments) (GtkExText * text, GtkAdjustment * hadjustment, GtkAdjustment * vadjustment);
...
/* text API */
   ...
   void gtk_extext_insert_with_style(GtkExText * text, const char *chars, gint len, gchar * stylekey, gpointer userdata);

   void gtk_extext_insert_text(GtkExText * text, const gchar * new_text, gint new_text_length, gint * position);
...
/* Line and column API */
   ...
   void gtk_extext_set_line_pixmap(GtkExText * text, gint line, GdkPixmap * pixmap, GdkBitmap * mask);
   gboolean gtk_extext_get_line_pixmap(GtkExText * text, gint line, GdkPixmap ** pixmap, GdkBitmap ** mask);
...
/* for example startpos=gtk_extext_get_position() */
   ...
   GList *gtk_extext_syntax_entry_new(GList * entries, gchar * name, gchar * start, gchar * end, GdkColor * fg, GdkColor * bg, GdkFont * font, guint16 flags, gpointer data);
   GList *gtk_extext_pattern_entry_new(GList * entries, gchar * name, gchar * start, GdkColor * fg, GdkColor * bg, GdkFont * font, guint16 flags, gpointer data);
   GList *gtk_extext_embedded_entry_new(GList * entries, gchar * name, gchar * outside, gchar * inside, GdkColor * fg, GdkColor * bg, GdkFont * font, guint16 flags, gpointer data);

   void gtk_extext_install_table(GtkExText * text, GtkExTextHighlightTable * table);
