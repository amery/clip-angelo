...
static target_table, n_targets

function Main()
local win, layout, btn, iter, model, renderer, j
local i, col1, col3, column1, column3, box, sw, stbar, twin, tmodel, path, path1, pathstr, tcolumn1, tcolumn3, tbox, tsw, tstbar
	...
	gtk_WindowSetDefaultSize(win, 280, 435)
        ...
        for i=1 to 10
                ...
                gtk_ListStoreAppend(list, 1, "str ������"+alltrim(str(i)), ;
                                          2, .t., ;
                		          3, (111.0*i), ;
                                          4, date(), ;
                                          5, "pink", ;
	...
	/************ FIRST VARIANT CREATE VIEW COLUMN  *****************/
  	...
  	*** insert new column to view
  	col1 = gtk_TreeViewInsertColumnWithAttributes(view, -1, "������ 1", renderer, ;
  		"text", 1, ;
  		"editable", 2, ;
  		"background", 5)
  	...
  	*** create next text cell
  	...
  	col3 = gtk_TreeViewInsertColumnWithAttributes(view, -1, "� ��� � �����", renderer, ;
  		"text", 3, "editable", 2)
...
/****
  	...
  	*** create column1
  	column1 = gtk_TreeViewColumnNew()
        gtk_TreeViewColumnSetTitle(column1, "������ 1")
	...
	gtk_TreeViewColumnSetSortColumnId(column1, 1)
  	...
  	*** create column3
  	column3 = gtk_TreeViewColumnNew()
        gtk_TreeViewColumnSetTitle(column3, "� ��� � �����")
...
*****************************************************************************/
	...
	tview = gtk_TreeViewNewWithModel(,tmodel)
  	...
  	gtk_TreeViewSetHeadersVisible (tview, .t.)
        ...
        for i=1 to 10
                path = gtk_TreeStoreAppend(tree, NIL, 1, "tree ������"+alltrim(str(i)), ;
                                          2, .t. , ;
                		          3, (111.0*i), ;
                                          4, date(), ;
                                          5, "red", ;
  	...
  	*** insert new column to view
  	col1 = gtk_TreeViewInsertColumnWithAttributes(tview, -1, "������ 1", renderer, ;
  		"text", 1, ;
  		"editable", 2)
  	...
  	*** create next text cell
  	...
  	col3 = gtk_TreeViewInsertColumnWithAttributes(tview, -1, "� ��� � �����", renderer, ;
  		"text", 3, "editable", 2)
...
local model, value, iter, path, pathstr, log, num, dat, selection
