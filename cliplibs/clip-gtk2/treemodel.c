...
clip_GTK_TREEMODELFILTERSETVISIBLEFUNC(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_model_filter_set_visible_func(GTK_TREE_MODEL_FILTER(ctreemodel->object), (GtkTreeModelFilterVisibleFunc) _visible_func, c, NULL);
...
clip_GTK_TREEMODELFILTERCONVERTCHILDITERTOITER(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_model_filter_convert_child_iter_to_iter(GTK_TREE_MODEL_FILTER(ctreemodel->object), Iter, GTK_TREE_ITER(cchild->object));
...
clip_GTK_TREEMODELFILTERCONVERTITERTOCHILDITER(ClipMachine * ClipMachineMemory)
{
   ...
   gtk_tree_model_filter_convert_iter_to_child_iter(GTK_TREE_MODEL_FILTER(ctreemodel->object), Iter, GTK_TREE_ITER(cchild->object));
...
clip_GTK_TREEMODELFILTERCONVERTCHILDPATHTOPATH(ClipMachine * ClipMachineMemory)
{
   ...
   npath = gtk_tree_model_filter_convert_child_path_to_path(GTK_TREE_MODEL_FILTER(ctreemodel->object), GTK_TREE_PATH(cpath->object));
...
clip_GTK_TREEMODELFILTERCONVERTPATHTOCHILDPATH(ClipMachine * ClipMachineMemory)
{
   ...
   npath = gtk_tree_model_filter_convert_path_to_child_path(GTK_TREE_MODEL_FILTER(ctreemodel->object), GTK_TREE_PATH(cpath->object));
...
clip_GTK_TREEMODELSORTCONVERTCHILDPATHTOPATH(ClipMachine * ClipMachineMemory)
{
   ...
   npath = gtk_tree_model_sort_convert_child_path_to_path(GTK_TREE_MODEL_SORT(ctreemodel->object), GTK_TREE_PATH(cpath->object));
...
clip_GTK_TREEMODELSORTCONVERTPATHTOCHILDPATH(ClipMachine * ClipMachineMemory)
{
   ...
   npath = gtk_tree_model_sort_convert_path_to_child_path(GTK_TREE_MODEL_SORT(ctreemodel->object), GTK_TREE_PATH(cpath->object));
