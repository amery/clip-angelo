...
#include <fwin/ci_Dialog.ch>
#include <fwin/ci_Font.ch>
#include <fwin/ci_FwIni.ch>
#include <fwin/ci_Menu.ch>
#include <fwin/ci_Print.ch>

//#ifndef CLIPPER501
   #include <fwin/ci_Colors.ch>
   #include <fwin/ci_DLL.ch>
   #include <fwin/ci_Folder.ch>
//   #include <fwin/Objects.ch>
   #include <fwin/ci_ODBC.ch>
   #include <fwin/ci_DDE.ch>
   #include <fwin/ci_Video.ch>
   #include <fwin/ci_VKey.ch>
   #include <fwin/ci_Tree.ch>
   #include <fwin/ci_WinApi.ch>
//#endif
