...
int       _clip_trap_err(ClipMachine * ClipMachineMemory, int genCode, int canDefault, int canRetry, const char *subSystem,
			 int subCode, const char *operation);
void      _clip_trap_invargv(ClipMachine * ClipMachineMemory, const char *filename, int line);

int       _clip_trap_operation(ClipMachine * ClipMachineMemory, const char *filename, int line, const char *oper,
			       ClipVar * lval);
...
char     *_clip_ttoc(ClipMachine * ClipMachineMemory, long julian, long time,
		     int *retlen, char *date_format, int hours, int seconds);
...
int       _clip_parse_name(ClipMachine * ClipMachineMemory, char *name, int l,
			   char **anamep, int *alp, char **fnamep, int *flp, long **dimp, int *ndimp);
