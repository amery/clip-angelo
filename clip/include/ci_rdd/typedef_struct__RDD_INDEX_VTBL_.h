typedef struct _RDD_INDEX_VTBL_
{
  ...
  /* navigation */
   ...
   int       (*seek) (ClipMachine * ClipMachineMemory, RDD_DATA * rd, RDD_ORDER * ro,
		      ClipVar * v, int soft, int last, int *found, const char *__PROC__);
   int       (*gotokey) (ClipMachine * ClipMachineMemory, RDD_DATA * rd, RDD_ORDER * ro,
   ...
   int       (*wildskip) (ClipMachine * ClipMachineMemory, RDD_DATA * rd, RDD_ORDER * ro,
  ...
  /* rushmore */
   int       (*setscope) (ClipMachine * ClipMachineMemory, RDD_DATA * rd, RDD_ORDER * ro,
  ...
  /* Independed Indexes */
   ...
   int       (*ii_createtag) (ClipMachine * ClipMachineMemory, RDD_INDEX * ri,
			      const char *tag, const char *expr, RDD_ORDER ** rop, const char *__PROC__);
   int       (*ii_open) (ClipMachine * ClipMachineMemory, RDD_INDEX * ri, const char *__PROC__);
   int       (*ii_opentag) (ClipMachine * ClipMachineMemory, RDD_INDEX * ri,
			    const char *tag, RDD_ORDER ** rop, const char *__PROC__);
   int       (*ii_addkey) (ClipMachine * ClipMachineMemory, RDD_ORDER * ro, const char *id,
			   ClipVar * key, const char *__PROC__);
  ...
  /* for filter optimization */
   int       (*calcfiltlist) (ClipMachine * ClipMachineMemory, RDD_DATA * rd,
			      RDD_ORDER * ro, RDD_FILTER * fp, const char *__PROC__);
  /* index locks */
