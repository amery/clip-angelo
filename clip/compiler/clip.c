...
#endif
#include "clip/static_get_env.h"

#define GETENV(val) get_env(val,getenv(val))
#include "clip/static_getEnvironment.h"

#undef GETENV
#include "clip/static_getrc.h"

#define flag_STATIC 257
#define flag_FULLSTATIC 258
#include "clip/static_struct_option_long_options.h"

#include "clip/get_opt.h"
#include "clip/static_diff_clock.h"

static char **ovect = 0;

static int onum = 0;

#include "clip/static_add_name.h"

char     *__progname;

#include "clip/static_lib_name.h"
#include "clip/static_init_module.h"
#include "clip/static_write_names.h"
#include "clip/static_check_names.h"
#include "clip/static_pr_errorcount.h"
#include "clip/main.h"
