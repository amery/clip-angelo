...
clip_SQLLIST(ClipMachine * ClipMachineMemory)
{
   ...
   for (i = 0; i < *ClipMachineMemory->nsqldrivers; i++)
   {
      ...
      e.ClipStrVar_s_of_ClipVar.ClipBuf_str_of_ClipStrVar.len_of_ClipBuf = strlen((*ClipMachineMemory->sqldrivers)[i].id_of_SQLDriver);
      ...
      e.ClipStrVar_s_of_ClipVar.ClipBuf_str_of_ClipStrVar.len_of_ClipBuf = strlen((*ClipMachineMemory->sqldrivers)[i].name_of_SQLDriver);
