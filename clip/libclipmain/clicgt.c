...
#include <clicgt/static_m_access.c>
#include <clicgt/static_init_locale.c>
#include <clicgt/static_nls_uint32_SWAP.c>
#include <clicgt/static_find_msg.c>
...
#include <clicgt/static_hash_string.c>

#include <clicgt/_clic_gettext.c>
#include <clicgt/_clic_ngettext.c>
#include <clicgt/tr_charset.c>
