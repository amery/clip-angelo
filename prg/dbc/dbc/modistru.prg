...
#else
   @  4, 26 SAY IIF( prnew, "�������� ������ 䠩��", "��������� " + msfile[ improc ] )
#endif
   OutCtrls( ctrl_ar )
   DO WHILE rez
      LI_LSOHR := .F.
...
PRIVATE ctrl_ar2 := { "+W/RB,+W/B", ;
                         { { "",, 7, 13, 15, 21 }, ;
                         { "Ins - Insert",, 17, 12 }, { "Del - Delete",, 17, 32 }, { "F6 - ������ ��� ����",, 17, 46 } } }
#else
PRIVATE ctrl_ar1 := { "+W/RB,+W/B", ;
                         { { "",, 7, 37, 15, 55 }, ;
                         { "Ins - ������� ����",, 17, 12 }, { "F5 - Select all fields",, 17, 32 } } }
PRIVATE ctrl_ar2 := { "+W/RB,+W/B", ;
                         { { "",, 7, 13, 15, 21 }, ;
                         { "Ins - ��⠢���",, 17, 12 }, { "Del - �������",, 17, 32 }, { "F6 - ������ ��� ����",, 17, 46 } } }
#endif
