...
#else
      @  7, 22 SAY "�������� ����" GET finame WHEN VLDFIELD( @finame )
...
PRIVATE prdbf, prsdf, prdelim, cdelim := " ", msknop1 := { "X", " ", " " }
   ...
   SET COLOR TO +W/GR,N+/W,,,+W/GR
   @  6, 20, 14, 70 BOX m->ORAMKA
   @  7, 22 SAY "�������� ��" GET fname PICTURE REPLICATE( 'X', 35 )
#ifdef ENGLISH
   @  8, 22 SAY "Fields:" GET fielname PICTURE "@S30"
#else
   @  8, 22 SAY "����:" GET fielname PICTURE "@S30"
#endif
   VvType( 9, 22 )
   @ 12, 22 SAY "FOR"
   @ 13, 22 GET strfor PICTURE "@S46"
