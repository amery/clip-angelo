...
Check_Bin 	indent 			xyz 	clip 			Yes 	/usr/bin 			"indent-xx-$ARCH.(rpm/deb)"
...
#Check_Include 		Xmu/Atoms.h 			xyz 	clip/xclip 		yes 	/usr/include/X11 									"libxmu-static-devel-$ARCH.(rpm/deb)"

Check_Bin xclip 				xyz 	clip 			No 	/usr/bin 			"xclip-xx-$ARCH.(rpm/deb)"
...
Check_Include 		gtkextra/gtkextra.h  xyz   clip-gtkextra 	yes 	/usr/include  										"libgtk-extra-devel-$ARCH.(rpm/deb)"
...
Check_Include 		jpeglib.h 				xyz 	clip				Yes 	/usr/include 										"lib(m)jpeg-static-devel-xx-$ARCH.(rpm/deb)"
...
Check_Include 		png.h 					xyz 	clip				Yes 	/usr/include 										"libpng-static-devel-xx-$ARCH.(rpm/deb)"
...
Check_Include 		dbftp.h 				xyz 	clip-dbtcp 		Yes 	/opt/dbtcp 												"dbtcp.xx.tgz" \
																																				"can be downloaded at" \
																																				"http://packages.qa.debian.org/d/dbtcp.html"
...
Check_Include 		utmp.h 					xyz 	clip				Yes 	/usr/include 										"glibc-devel-xx-$ARCH.(rpm/deb)"
#Check_Include 		X11/xpm.h 				xyz 	clip-gd 			Yes 	/usr/include 										"libxpm-static-devel-xx-$ARCH.(rpm/deb)"
