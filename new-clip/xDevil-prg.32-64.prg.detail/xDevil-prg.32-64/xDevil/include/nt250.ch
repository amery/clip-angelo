...
*    NT250.CH
*
*    General adaptations for Clipper Tools II / 5.0
...
*    co-operation with Clipper 5.01 and the compatibility with
*    former versions.
...
*************************************************************************
*
* In the new release of Nantucket Tools II / 5.01 all functions having
...
* Under Clipper 5.01, the SETCURSOR() function returns the current
